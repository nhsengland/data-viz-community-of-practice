...
???+ tip "KPIs - Best practices"
    ...
    - [x] <p class="inline-container">If a KPI slot does not have a click-through, then its title should be in NHS Black <span class="inline-container-pill" style="--colour: #212B32;"><span class="inline-colour-square" style="--colour: #212B32; width: 15px; height: 15px"></span>#212B32</span> without an arrow</p>
